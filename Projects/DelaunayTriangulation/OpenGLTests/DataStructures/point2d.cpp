 ...
 * @param y
 */
template<> Point2D<double>::Point2D(double x, double y): xCoord(x), yCoord(y) {
}
...
template<> const double& Point2D<double>::x() const {
    return xCoord;
}
 ...
 */
template<> const double& Point2D<double>::y() const {
    return yCoord;
}
...
template <> double Point2D<double>::dist(const Point2D<double> &otherPoint) const{
 ...
 */
template <> bool Point2D<double>::operator == (const Point2D<double>& otherPoint) const {
 ...
 */
template<> double& Point2D<double>::x() {
    return xCoord;
}
 ...
 */
template<> double& Point2D<double>::y() {
    return yCoord;
}
